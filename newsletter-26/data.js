...
function buildJson(directoryName) {
  ...
  return {
    intro: {
      title: "שנה חדשה, קוד נקי: Cursor, TanStack ו־knip שעושים סדר בבלגן",
      content: introContent,
    },
    articles: [
      {
        title: "Cursor AI Agents: קיבלתם קידום ו-10 מפתחים תחתיכם",
      ...
      {
        title: "ניקוי קוד עם knip: הסרת JavaScript מת",
